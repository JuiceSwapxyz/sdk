import { MixedRouteSDK, Trade as RouterTrade } from '@juiceswapxyz/router-sdk'
import { Currency, CurrencyAmount, Ether, Token, TradeType } from '@juiceswapxyz/sdk-core'
import { Pair, Route as V2Route } from '@juiceswapxyz/v2-sdk'
import { Pool as V3Pool, Route as V3Route, FeeAmount } from '@juiceswapxyz/v3-sdk'
